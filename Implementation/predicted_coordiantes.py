...
a.sort_values(by='id', ascending=True, inplace=True) 
print(a)

a.to_csv(r"C:\Users\insan\OneDrive\thesis_development\Geoparsing_Thesis_Msc\Implementation\data\Data_Set\Location_Coordinates.csv", index=False)
gdf= geopandas.GeoDataFrame(a ,geometry=geopandas.points_from_xy(a.Lat, a.Long))
gdf[['id','tweet','Location','Lat','Long','geometry']]
